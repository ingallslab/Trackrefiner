...
In steps [Swapped track links and missing division links](https://github.com/ingallslab/Trackrefiner/tree/main/dev_docs/algorithm_workflow#feature-based-identification-and-correction-flow-chart-for-swapped-track-links-and-missing-division-links) and [Untimely root and leaf](https://github.com/ingallslab/Trackrefiner/tree/main/dev_docs/algorithm_workflow#feature-based-identification-and-correction-for-untimely-root-and-leaf), there is a box labeled <i>Evaluate the feasibility of making new links based on biological limits, data-driven thresholds, and the likelihoods predicted by the models</i>. This box is further detailed in a separate flowchart, corresponding to [Applying Classifiers](https://github.com/ingallslab/Trackrefiner/tree/main/dev_docs/algorithm_workflow#applying-classifiers).
</p>
